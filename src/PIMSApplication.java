...
public class PIMSApplication {
    ...
    private void showLogin() {
        ...
        brandPanel.setBackground(new Color(28, 112, 96));
        brandPanel.setPreferredSize(new Dimension(285, 0));
        ...
        brandConstraints.insets = new Insets(8, 28, 8, 28);
        JLabel brand = new JLabel("HealthFirst");
        brand.setForeground(Color.WHITE);
        brand.setFont(new Font("Arial", Font.BOLD, 30));
        JLabel brandSubheading = new JLabel("Pharmacy Inventory System");
        brandSubheading.setForeground(new Color(220, 245, 237));
        brandSubheading.setFont(new Font("Arial", Font.PLAIN, 15));
        JLabel brandMessage = new JLabel("Simple, secure pharmacy management");
        brandMessage.setForeground(new Color(220, 245, 237));
        brandMessage.setFont(new Font("Arial", Font.PLAIN, 13));
        brandConstraints.gridy = 0;
        brandPanel.add(brand, brandConstraints);
        brandConstraints.gridy = 1;
        brandPanel.add(brandSubheading, brandConstraints);
        brandConstraints.gridy = 2;
        brandConstraints.insets = new Insets(28, 28, 8, 28);
        brandPanel.add(brandMessage, brandConstraints);
        ...
        formConstraints.insets = new Insets(6, 0, 6, 0);
        JTextField username = new JTextField();
        JPasswordField password = new JPasswordField();
        JButton login = new JButton("Login");
        username.setPreferredSize(new Dimension(0, 38));
        password.setPreferredSize(new Dimension(0, 38));
        login.setPreferredSize(new Dimension(0, 42));
        login.setFont(new Font("Arial", Font.BOLD, 14));
        JLabel heading = new JLabel("Staff sign in");
        heading.setFont(new Font("Arial", Font.BOLD, 24));
        JLabel instruction = new JLabel("Use your HealthFirst account to continue");
        instruction.setForeground(new Color(90, 105, 102));
        JLabel usernameLabel = new JLabel("Username");
        JLabel passwordLabel = new JLabel("Password");
        formConstraints.gridy = 0;
        panel.add(heading, formConstraints);
        formConstraints.gridy = 1;
        panel.add(instruction, formConstraints);
        formConstraints.gridy = 2;
        formConstraints.insets = new Insets(28, 0, 3, 0);
        panel.add(usernameLabel, formConstraints);
        formConstraints.gridy = 3;
        formConstraints.insets = new Insets(3, 0, 8, 0);
        panel.add(username, formConstraints);
        formConstraints.gridy = 4;
        formConstraints.insets = new Insets(8, 0, 3, 0);
        panel.add(passwordLabel, formConstraints);
        formConstraints.gridy = 5;
        formConstraints.insets = new Insets(3, 0, 14, 0);
        panel.add(password, formConstraints);
